...
const ServicesSection = () => {
  ...
  return <section className="py-20 subtle-gradient">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <div key={index} ref={el => serviceRefs.current[index] = el} className={`bg-card p-8 rounded-2xl shadow-soft hover:shadow-medium transition-smooth ${visibleItems.includes(index) ? 'reveal-up in-view' : 'reveal-up'}`} style={{
