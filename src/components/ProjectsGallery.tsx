                ...
                <div className={`p-8 lg:p-12 flex flex-col justify-center ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="bg-secondary text-secondary-foreground px-3 py-1 rounded-lg text-sm font-medium"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex gap-4">
                    <button className="btn-accent">View Project</button>
                    <button className="btn-primary bg-transparent border border-border text-foreground hover:bg-muted">
                      Case Study
                    </button>
                  </div>
                </div>
